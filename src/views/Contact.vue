      ...
      <div class="col-span-4 bg-gray-50 px-8 py-10 text-gray-800 md:col-span-2 md:border-r md:px-10 md:py-12 lg:col-span-1">
        ...
        <ul>
          <li class="mb-6 flex items-start text-left">
            ...
            <div>
              <a class="cursor-pointer font-serif text-base md:text-lg" href="mailto:saputranurahman24@gmail.com?subject=haiiiii%20saputtt">celvin24@gmail.com</a>
          ...
          <a href="https://www.instagram.com/sputxxzz_">
            ...
            <div>
              <a class="cursor-pointer font-serif text-base md:text-lg" href="https://www.instagram.com/sputxxzz_">vinn</a>
         ...
         <a href="https://wa.link/a6ko79">
            ...
            <div>
              <p class="font-serif text-base md:text-lg">0838059078913</p>
